  ...
  ({
    ...
    useMemo(() => {
      ...
      obj.current = {
        ...obj.current,
        name:
          CapitalizeFirst(t('dataModel:stateProperties.' + stateType.toLowerCase() + 'State')) +
            unit +
            (nameExtra ? ' | ' + nameExtra : '') || undefined,
        id: stateId,
        type: stateType,
        valueId: id,
        isNumber: false,
        isBoolean:
          ...
          value.number.max - value.number.min === value.number.step,
      };
