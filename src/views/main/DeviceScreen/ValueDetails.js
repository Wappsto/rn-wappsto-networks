            ...
            {!!value.blob.encoding && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.blobProperties.encoding')) + ': '
                  }
                />
            ...
            {!!value.blob.max && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.blobProperties.max')) + ': '
                  }
                />
            ...
            {exist(value.number.min) && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.numberProperties.min')) + ': '
                  }
                />
            ...
            {exist(value.number.max) && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.numberProperties.max')) + ': '
                  }
                />
            ...
            {exist(value.number.step) && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.numberProperties.step')) + ': '
                  }
                />
            ...
            {!!value.number.unit && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.numberProperties.unit')) + ': '
                  }
                />
            ...
            {!!value.string.encoding && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.stringProperties.encoding')) + ': '
                  }
                />
            ...
            {!!value.string.max && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.stringProperties.max')) + ': '
                  }
                />
          ...
          <>
            {!!value.xml.xsd && (
              <RNText>
                <Text
                  bold
                  content={CapitalizeFirst(t('dataModel:valueProperties.xmlProperties.xsd')) + ': '}
                />
            ...
            {!!value.xml.namespace && (
              <RNText>
                <Text
                  bold
                  content={
                    CapitalizeFirst(t('dataModel:valueProperties.xmlProperties.namespace')) + ': '
                  }
                />
...
const ValueSettings = React.memo(({ item }) => {
  ...
  const content = useCallback(
    (visible, hide) => {
      const states = useEntitiesSelector('state', {
        parent: { type: 'value', id: item.meta.id },
      });
        ...
        <Popup visible={visible} onRequestClose={hide} hide={hide}>
          ...
          {!!item.permission && (
            <RNText>
              <Text
                bold
                content={CapitalizeFirst(t('dataModel:valueProperties.permission')) + ': '}
              />
          ...
          {!!item.description && (
            <RNText>
              <Text
                bold
                content={CapitalizeFirst(t('dataModel:valueProperties.description')) + ': '}
              />
          ...
          {!!valueDataType.text && (
            <RNText>
              <Text
                bold
                content={CapitalizeFirst(t('dataModel:valueProperties.dataType')) + ': '}
              />
              ...
              <View style={styles.container} key={state.meta.id}>
                <Text
                  ...
                  content={CapitalizeFirst(
                    t(
                      'dataModel:stateProperties.' +
                        (state.type === 'Report' ? 'reportState' : 'controlState'),
                    ),
                  )}
                />
                <ID
                  id={state.meta.id}
                  label={CapitalizeFirst(t('dataModel:stateProperties.meta.id'))}
                />
                <RNText>
                  <Text
                    bold
                    content={CapitalizeFirst(t('dataModel:universalMeta.historical')) + ': '}
                  />
                  <Text
                    content={
                      state.meta.historical
                        ? CapitalizeFirst(
                            t('dataModel:universalMeta.historicalOptions.' + state.meta.historical),
                          )
                        : CapitalizeFirst(t('dataModel:universalMeta.historicalOptions.true'))
                    }
                  />
                </RNText>
                <RNText>
                  <Text
                    bold
                    content={CapitalizeFirst(t('dataModel:stateProperties.data')) + ': '}
                  />
                ...
                <RNText>
                  <Text
                    bold
                    content={CapitalizeFirst(t('dataModel:stateProperties.timestamp')) + ': '}
                  />
